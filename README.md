...
#### 강조<br>
*이텔릭 체는* 양쪽에 (별표)하나 사이에 감싸기<br>
**두껍게는** 양쪽에 (별표)두개 사이에 감싸기<br>
~~취소선은~~ 양쪽에 (물결표) 두개 사이에 감싸기 <br>
순서가 필요한 목록
1.
2.
3.
...
#### 외부링크
대괄호 보여주고싶은 글 대괄호 (주소)<br>
[naver](https://naver.com)

#### 내부링크
대괄호 목차 대괄호 (#index)       [목차](#index)<br>

#### 이미지
마크다운 이미지 코드를 링크 코드로 묶어 줍니다.<br>
대괄호! 대괄호Vue대괄호 (/images/vue.png)](https://kr.vuejs.org/)<br>
